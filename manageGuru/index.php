<?php
  ...
  require '../backEnd/Controller/insertDataGuru.php' ; 
  require '../backEnd/Controller/updateDataGuru.php' ;
...
<body>
            ...
            <div class="container bg-dark" style="position:fixed; width: 25%; height:100%">
                ...
                <ul class=" list-group list-group-flush">
                    ...
                    <li class="bg-dark list-group-item">
                            <a class="font-weight-bolder text-light" style="font-size:18px; margin:10px" href="../manageGuru">
                                    Management Guru
                            </a>
                    </li>
                    <li class="bg-dark list-group-item">
        ...
        <div class="card-header">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="#">Semua guru</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Mapel 1</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Mapel 2</a>
            </li>
            </ul>
        </div>
        <div class="card-body">
            ...
            <tbody>
                <?php $i=1;foreach($Guru as $res) : ?>
                <tr>
                <th scope="row"><?= $i ?></th>
                <th scope="row" class="text-justify"><?= $res['Nama'] ?></th>
                <th><?= $res['NIP'] ?></th>
                <td><?= $res['Alamat'] ?></td>
                <td><?= $res['Tgl_Masuk'] ?></td>
                <td><?= $res['Tgl_Keluar'] ?></td>
                <td><img src="../assets/img/<?= $res['Img_Guru'] ?>" alt="<?= $res['Img_Guru'] ?>" width='50px';></td>
                <td>
                    <button type="button" class="btn btn-success" id="" data-toggle="modal" data-target="#editGuru<?= $res['NIP'] ?>">
                        edit
                    </button>
                </td>
                </tr>    
        ...
        <!-- MODAL EDIT -->
        <div class="modal fade" id="editGuru<?= $res['NIP'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Edit guru</h5>
            ...
            <div class="modal-body">
                <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                    <div class="text-xl-left mr-5 ml-5 form-group">
                        <input type="hidden" name="NIP" value="<?= $res['NIP'] ?>">
                        <label for="nama">Nama</label>
                        <input type="text" name="Nama" class="form-control" id="nama" placeholder="<?= $res['Nama'] ?>" value="<?= $res['Nama'] ?>">
                    </div>
                    <div class="text-xl-left mr-5 ml-5 form-group">
                        <label for="alamat">Alamat</label>
                        <input type="text" name="Alamat" class="form-control" id="alamat" placeholder="<?= $res['Alamat'] ?>" value="<?= $res['Alamat'] ?>">
                    </div>
                    <div class="text-xl-left mr-5 ml-5 form-group">
                    ...
                    <div class="form-group text-xl-left mr-5 ml-5 ">  
                        ...
                        <input type="hidden" name="gambarLama" value="<?= $res['Img_Guru'] ?>">
                    </div>
            </div>
            <div class="modal-footer">
                    <button class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" name="updateGuru" class="btn btn-primary">Edit</button>
                </form>
            </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah guru</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
